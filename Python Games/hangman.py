...
def preguess(tries, depict, guessed_letters):
  ...
  print()
  print()
  print("Guessed letters/words: ", end ="")
...
def guess(attempt, secret):
  ...
  if (correct == 0):
    print()
    time.sleep(1.75)
    print("I'm Sorry. But your choice was incorrect")
    return 0
...
def main():
    ...
    print()
    time.sleep(2)
    print("You will be given a random word. And you only have SEVEN (7) lives")
    time.sleep(2)
    print()
    print("Goodluck")
    print()
    ...
    while True:
        ...
        time.sleep(1.75)
        print()
        print("Oh. You seem to have choosen a letter or word that you have already tried. Try Again")
        time.sleep(1.75)
