...
int main(){
    ...
    vector<size_t> layers4 = {DIM*DIM,DIM*DIM/4,100,10,3};
    ...
    try{
        ...
        dnn.train(training_data, training_label, 35 , 0.01, dnn.maxIndx, true, true); //training data with learning rate of 0.01 on 35 epochs
        cout << endl;
